...
(
    ...
    ignore_dependencies_flag boolean NOT NULL DEFAULT false,
...
ALTER TABLE meta.project
ADD COLUMN IF NOT EXISTS ignore_dependencies_flag boolean NOT NULL DEFAULT false;
